...
norm_images, norm_labels = load_normal('chestxray/train/NORMAL/')
pneu_images, pneu_labels = load_pneumonia('chestxray/train/PNEUMONIA/')
...
norm_images_test, norm_labels_test = load_normal('chestxray/test/NORMAL/')
pneu_images_test, pneu_labels_test = load_pneumonia('chestxray/test/PNEUMONIA/')
